...
{
$course=$_POST['course'];
// $cou_duratiom=$_POST['cou_duration'];

$user="SELECT * FROM courses WHERE course='$course'";
// $user1="SELECT * FROM courses WHERE cou_duration='$cou_duration'";
$query = mysqli_query($conn, $user);
  ...
  if(mysqli_num_rows($query) > 0 ) { //check if there is already an entry for that username
    ...
    // $sq2="INSERT INTO courses(`cou_duration`) VALUES ('$cou_duration')";
                  ...
                  <tbody>
                    <tr>
                      <td><?php echo $row['id']; ?></td>
                        ...
                        <td><?php echo $row['cou_duration']; ?></td>
          ...
          <div class="modal-body" style="background-image: linear-gradient(#000066,#ffffff);">
            ...
            <section class="logsection">
               <div class="logform">
                  ...
                  <input type = "number" id  ="" name="cou_duration" placeholder = " enter the number" required="value"><br><br>

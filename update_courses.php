...
// $sq2="UPDATE courses set cou_duration='".$_POST['cou_duration']."' WHERE id='".$_POST['id1']."'";
...
// $recod1= "SELECT * from courses WHERE id='".$_GET['id']."'";
          ...
          <div class="modal-body" style="background-image: linear-gradient(#000066,#ffffff);">
            ...
            <section class="logsection">
               <div class="logform">
                  ...
                  <input type = "number" id1  ="" name="cou_duration" placeholder = " enter the number" value="<?php echo $row['cou_duration']; ?>" required="value"><br><br>
